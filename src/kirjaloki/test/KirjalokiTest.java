 ...
 * @version 2026.03.12 00:12:21 // Generated by ComTest
 *
 */
...
public class KirjalokiTest {
   ...
   */
  @Test
  public void testEtsi64() throws CloneNotSupportedException, SailoException {    // Kirjaloki: 64
    alustaKirjaloki(); 
    ...
    assertEquals("From: Kirjaloki line: 71", 1, loytyneet.size()); 
    Iterator<Kirjailija> it = loytyneet.iterator(); 
    assertEquals("From: Kirjaloki line: 73", true, it.next() == kirjailija3); 
  } // Generated by ComTest END
   ...
   */
  @Test
  public void testAnnaKirjat99() throws SailoException {    // Kirjaloki: 99
    alustaKirjaloki(); 
    ...
    assertEquals("From: Kirjaloki line: 107", 0, loytyneet.size()); 
    loytyneet = kirjaloki.annaKirjat(kytomaki1); 
    assertEquals("From: Kirjaloki line: 109", 2, loytyneet.size()); 
    assertEquals("From: Kirjaloki line: 110", true, loytyneet.get(0) == margarita11); 
    assertEquals("From: Kirjaloki line: 111", true, loytyneet.get(1) == margarita12); 
    loytyneet = kirjaloki.annaKirjat(kytomaki2); 
    assertEquals("From: Kirjaloki line: 113", 3, loytyneet.size()); 
    assertEquals("From: Kirjaloki line: 114", true, loytyneet.get(0) == margarita21); 
  } // Generated by ComTest END
   ...
   */
  @Test
  public void testLisaa134() throws SailoException {    // Kirjaloki: 134
    alustaKirjaloki(); 
    assertEquals("From: Kirjaloki line: 137", 2, kirjaloki.etsi("*",0).size()); 
    kirjaloki.lisaa(kytomaki1); 
    assertEquals("From: Kirjaloki line: 139", 3, kirjaloki.etsi("*",0).size()); 
  } // Generated by ComTest END
   ...
   */
  @Test
  public void testLueTiedostosta159() throws SailoException {    // Kirjaloki: 159
    ...
    fail("Kirjaloki: 172 Did not throw SailoException");
    ...
    assertEquals("From: Kirjaloki line: 180", kytomaki1, it.next()); 
    assertEquals("From: Kirjaloki line: 181", kytomaki2, it.next()); 
    assertEquals("From: Kirjaloki line: 182", false, it.hasNext()); 
    List<Kirja> loytyneet = kirjaloki.annaKirjat(kytomaki1); 
    Iterator<Kirja> ih = loytyneet.iterator(); 
    assertEquals("From: Kirjaloki line: 185", false, ih.hasNext()); 
    loytyneet = kirjaloki.annaKirjat(kytomaki2); 
    ih = loytyneet.iterator(); 
    assertEquals("From: Kirjaloki line: 188", false, ih.hasNext()); 
    kirjaloki.lisaa(kytomaki2); 
    kirjaloki.tallenna();  // tekee molemmista .bak
    assertEquals("From: Kirjaloki line: 191", true, ftied.delete()); 
    assertEquals("From: Kirjaloki line: 192", true, fhtied.delete()); 
    File fbak = new File(hakemisto+"/nimet.bak"); 
    File fhbak = new File(hakemisto+"/kirjat.bak"); 
    assertEquals("From: Kirjaloki line: 195", true, fbak.delete()); 
    assertEquals("From: Kirjaloki line: 196", true, fhbak.delete()); 
    assertEquals("From: Kirjaloki line: 197", true, dir.delete()); 
  } // Generated by ComTest END


  // Generated by ComTest BEGIN
  /** 
   * testKorvaaTaiLisaa238 
   * @throws SailoException when error
   */
  @Test
  public void testKorvaaTaiLisaa238() throws SailoException {    // Kirjaloki: 238
    alustaKirjaloki(); 
    assertEquals("From: Kirjaloki line: 241", 2, kirjaloki.etsi("*",0).size()); 
    kirjaloki.lisaa(kytomaki1); 
    assertEquals("From: Kirjaloki line: 243", 2, kirjaloki.etsi("*",0).size()); 
  } // Generated by ComTest END
}