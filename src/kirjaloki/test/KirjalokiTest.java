 ...
 * @version 2026.03.11 23:19:08 // Generated by ComTest
 *
 */
...
public class KirjalokiTest {
   ...
   */
  @Test
  public void testAnnaKirjat93() throws SailoException {    // Kirjaloki: 93
    alustaKirjaloki(); 
   ...
   */
  @Test
  public void testLueTiedostosta153() throws SailoException {    // Kirjaloki: 153
    ...
    fail("Kirjaloki: 166 Did not throw SailoException");
    ...
    assertEquals("From: Kirjaloki line: 174", kytomaki1, it.next()); 
    assertEquals("From: Kirjaloki line: 175", kytomaki2, it.next()); 
    assertEquals("From: Kirjaloki line: 176", false, it.hasNext()); 
    List<Kirja> loytyneet = kirjaloki.annaKirjat(kytomaki1); 
    Iterator<Kirja> ih = loytyneet.iterator(); 
    assertEquals("From: Kirjaloki line: 179", false, ih.hasNext()); 
    loytyneet = kirjaloki.annaKirjat(kytomaki2); 
    ih = loytyneet.iterator(); 
    assertEquals("From: Kirjaloki line: 182", false, ih.hasNext()); 
    kirjaloki.lisaa(kytomaki2); 
    kirjaloki.tallenna();  // tekee molemmista .bak
    assertEquals("From: Kirjaloki line: 185", true, ftied.delete()); 
    assertEquals("From: Kirjaloki line: 186", true, fhtied.delete()); 
    File fbak = new File(hakemisto+"/nimet.bak"); 
    File fhbak = new File(hakemisto+"/kirjat.bak"); 
    assertEquals("From: Kirjaloki line: 189", true, fbak.delete()); 
    assertEquals("From: Kirjaloki line: 190", true, fhbak.delete()); 
    assertEquals("From: Kirjaloki line: 191", true, dir.delete()); 
  } // Generated by ComTest END


  // Generated by ComTest BEGIN
  /** 
   * testKorvaaTaiLisaa232 
   * @throws SailoException when error
   */
  @Test
  public void testKorvaaTaiLisaa232() throws SailoException {    // Kirjaloki: 232
    alustaKirjaloki(); 
    assertEquals("From: Kirjaloki line: 235", 2, kirjaloki.etsi("*",0).size()); 
    kirjaloki.lisaa(kytomaki1); 
    assertEquals("From: Kirjaloki line: 237", 2, kirjaloki.etsi("*",0).size()); 
  } // Generated by ComTest END
}